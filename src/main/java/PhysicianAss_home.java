...
/**
 * Servlet implementation class PhysicianAss_home
 */
@WebServlet("/PhysicianAss_home")
public class PhysicianAss_home extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PhysicianAss_home() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!utype.equals("Physician_Assistant")) {
        ...
        try {
			out.print("<html>");
			out.print("<head>");
			out.print("<title>Physician Assistant Home Page</title>");
			...
			out.print("<a href=Assign_doctor>Assign Doctor</a>");
			out.print("</div>");
			out.print("</div>");
