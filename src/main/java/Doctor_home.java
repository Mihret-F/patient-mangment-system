...
@WebServlet("/Doctor_home")
public class Doctor_home extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			out.print("<html>");
			out.print("<head>");
			out.print("<title>Doctor Home Page</title>");
			...
			out.print("<a href='View_assignedPatients?user_id=" + doctorID + "'>View Patients</a>");
			out.print("<a href='View_testResult?user_id=" + doctorID + "'>View TestResult</a>");
			out.print("</div>");
			out.print("</div>");
